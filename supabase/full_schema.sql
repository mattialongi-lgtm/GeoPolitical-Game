...
CREATE TABLE regions (
    ...
    "healthIndex" FLOAT DEFAULT 1,
    "militaryIndex" FLOAT DEFAULT 1,
    "educationIndex" FLOAT DEFAULT 1,
    "developmentIndex" FLOAT DEFAULT 1,
    "pollution" INT DEFAULT 0,
    "energyGeneration" FLOAT DEFAULT 0,
    "energyConsumption" FLOAT DEFAULT 0,
    "energyEfficiency" FLOAT DEFAULT 0,
    "dailyExtractionLimitGold" INT DEFAULT 1250,
    "dailyExtractionLimitOil" INT DEFAULT 300,
    "dailyExtractionLimitMinerals" INT DEFAULT 300,
    "dailyExtractionLimitUranium" INT DEFAULT 45,
    "dailyExtractionLimitDiamonds" INT DEFAULT 60,
